          ...
          <TabsContent value='general' className='space-y-4'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>配置您的 LLM 基本設置</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value='advanced' className='space-y-4'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>使用這些參數微調模型的行為</CardDescription>
              </CardHeader>
              <CardContent>
                <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
                  {/* Frequency Penalty */}
          ...
          <TabsContent value='prompts' className='space-y-4'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>配置系統和用戶提示詞模板</CardDescription>
              </CardHeader>
