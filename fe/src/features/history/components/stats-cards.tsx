    ...
    <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-4'>
      <Card>
        ...
        <CardContent>
          ...
          <p className='text-muted-foreground text-xs'>較上週增加 17.2%</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className='text-muted-foreground text-xs'>較上週增加 12.5%</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className='text-muted-foreground text-xs'>較上週增加 2.3%</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className='text-muted-foreground text-xs'>較上週減少 0.8分鐘</p>
        </CardContent>
      </Card>
    </div>
  )
